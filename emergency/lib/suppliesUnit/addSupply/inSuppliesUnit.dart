...
class supaddsuppliesInSuppliesUnitStatefullply extends StatefulWidget {
  @override
...
class _addMedicinInsuppliesState
    extends State<supaddsuppliesInSuppliesUnitStatefullply> {
  // def() {
  //   print("object");
  // }
