...
class reportSuppliesunit extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return reportSuppliesunitState();
  }
}

class reportSuppliesunitState extends State<reportSuppliesunit> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text("drug shelves unit",
